...
{
	extern luabind::functor<MonsterSpace::EBodyState>* CAI_Stalker__CombatSetBodyState;
	if (CAI_Stalker__CombatSetBodyState)
	{
		body_state = (*CAI_Stalker__CombatSetBodyState)(m_object->lua_game_object(), wo, body_state);
	}
	return body_state;
}
#endif
