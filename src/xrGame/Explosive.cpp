...
{
	PROF_EVENT("CExplosive::UpdateCL");
...
void CExplosive::net_Relcase(CObject* O)
{
	...
	CPhysicsShellHolder* hold = smart_cast<CPhysicsShellHolder*>(O);
	BLASTED_OBJECTS_I I = std::find(m_blasted_objects.begin(), m_blasted_objects.end(), hold);
