...
public:
	...
	virtual CExplosiveRocket* cast_explosive_rocket() { return NULL; }
	virtual CGrenade* cast_grenade() { return NULL; }
	virtual CUsableScriptObject* cast_usable_script_object() { return NULL; };
...
public:
	...
	virtual void OnChangeVisual(bool destroy = false);
