...
class game_sv_Single : public game_sv_mp
{
private:
...
protected:
	...
	xr_vector<xr_string> Default_Items;
public:
	game_sv_Single();
	...
	virtual void SendGamTasksData(ClientID target);
	virtual void SendPortionsData(ClientID target);
