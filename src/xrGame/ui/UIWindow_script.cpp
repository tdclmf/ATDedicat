...
// hud font
CGameFont* DefaultDedicFont = NULL;
CGameFont* GetFontSmall()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontStat;
}

CGameFont* GetFontMedium()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontMedium;
}

CGameFont* GetFontDI()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontDI;
}
...
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontGraffiti19Russian;
}

CGameFont* GetFontGraffiti22Russian()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontGraffiti22Russian;
}

CGameFont* GetFontLetterica16Russian()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontLetterica16Russian;
}

CGameFont* GetFontLetterica18Russian()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontLetterica18Russian;
}

CGameFont* GetFontGraffiti32Russian()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontGraffiti32Russian;
}

CGameFont* GetFontGraffiti50Russian()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontGraffiti50Russian;
}

CGameFont* GetFontLetterica25()
{
	if (g_dedicated_server) return DefaultDedicFont;
	return UI().Font().pFontLetterica25;
}
