...
private:
	...
	bool m_net_server_state_valid;
	u32 m_net_server_state_time;
	u8 m_net_server_movement_type;
	u8 m_net_server_body_state;
	u8 m_net_server_mental_state;
	float m_net_server_body_current_yaw;
	float m_net_server_body_target_yaw;
	float m_net_server_head_yaw;
	float m_net_server_head_pitch;
	float m_net_server_speed;
	float m_net_server_actual_speed;
	Fvector m_net_server_position;
	u32 m_net_server_update_timestamp;
	u16 m_net_server_active_slot;
	u16 m_net_server_active_item_id;
	u8 m_net_server_hud_state;
	u8 m_net_server_hud_next_state;
	u8 m_net_server_weapon_state;
	u8 m_net_server_weapon_next_state;
	u16 m_net_server_weapon_ammo_elapsed;
	u8 m_net_server_weapon_ammo_type;
	u8 m_net_server_weapon_zoomed;
	u8 m_net_server_weapon_working;
	u16 m_net_server_object_handler_item_id;
	u16 m_net_server_object_handler_state_id;
	bool m_net_server_animation_state_valid;
	u32 m_net_server_animation_state_applied_time;
	u32 m_net_server_anim_motion[5];
	u16 m_net_server_anim_time[5];
	u8 m_net_server_anim_flags[5];
	u32 m_net_server_anim_time_synced_motion[5];
	bool m_net_remote_smooth_valid;
	u32 m_net_remote_smooth_time;
	Fvector m_net_remote_smooth_position;
	bool m_net_anim_diag_valid;
	u32 m_net_anim_diag_last_log_time;
	u32 m_net_anim_diag_last_server_timestamp;
	Fvector m_net_anim_diag_last_server_pos;
	float m_net_anim_diag_last_server_yaw;
	float m_net_anim_diag_last_server_target_yaw;
	float m_net_anim_diag_last_server_speed;
	float m_net_anim_diag_last_server_actual_speed;
	u32 m_net_anim_diag_last_motion[5];
