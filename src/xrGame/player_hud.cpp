...
void attachable_hud_item::setup_firedeps(firedeps& fd)
{
	...
	{
		if(m_measures.m_fire_bone != BI_NONE && m_measures.m_fire_bone < m_model->LL_BoneCount())
		{
	...
	{
		if(m_measures.m_fire_bone2 != BI_NONE && m_measures.m_fire_bone2 < m_model->LL_BoneCount())
		{
	...
	{
		if (m_measures.m_shell_bone != BI_NONE && m_measures.m_shell_bone < m_model->LL_BoneCount())
		{
	...
	if (m_measures.m_fire_bone_silencer != BI_NONE && m_measures.m_fire_bone_silencer < m_model->LL_BoneCount())
	{
