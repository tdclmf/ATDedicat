...
{
	PROF_EVENT("CCustomMonster::update_sound_player");
...
void CCustomMonster::eye_pp_s0()
{
	// Eye matrix
	Fvector Eye_pos;
	Eye_pos = Visual()->dcast_PKinematics()->LL_GetTransform(u16(eye_bone)).c;
	Eye_pos.add(XFORM().c);
	...
	eye_matrix.c.add(Eye_pos, m_tEyeShift);
