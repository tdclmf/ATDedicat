...
// String utils
std::vector<std::string> splitStringMulti(const std::string& inputString, const std::string& separator = " ", bool includeSeparators = false, bool trimStrings = false);
std::vector<std::string> splitStringLimit(const std::string& inputString, const std::string& separator = " ", int limit = 0, bool trimStrings = false);
