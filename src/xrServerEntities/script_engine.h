...
public:
	...
	bool function_object(LPCSTR function_to_call, luabind::object& object, int type = LUA_TFUNCTION, bool load_fl = true);
	...
	template<typename F>
	IC void InitializeFunctor(F*& func, const char* name, bool load_fl = false);

	template <typename _result_type>
	IC bool functor(LPCSTR function_to_call, luabind::functor<_result_type>& lua_function, bool load_fl = true);
