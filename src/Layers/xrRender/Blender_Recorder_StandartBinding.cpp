...
class cl_binder_hdr10_parameters1 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if(RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_whitepoint_nits),
				(float)(ps_r4_hdr10_ui_nits / ps_r4_hdr10_whitepoint_nits),
				(float)(1),
				(float)(ps_r4_hdr10_pda)
			);
		}
#endif
	}
...
class cl_binder_hdr10_parameters2 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_colorspace),
				(float)(ps_r4_hdr10_pda_intensity),
				(float)(1u << ps_r4_hdr10_tonemapper),
				(float)(ps_r4_hdr10_tonemap_mode)
			);
		}
#endif
	}
...
class cl_binder_hdr10_parameters3 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_exposure),
				(float)(ps_r4_hdr10_contrast + 1.0f),
				(float)(ps_r4_hdr10_saturation + 1.0f),
				(float)(ps_r4_hdr10_contrast_middle_gray)
			);
		}
#endif
	}
} binder_hdr10_parameters3;

class cl_binder_hdr10_parameters4 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_bloom_on),
				(float)(ps_r4_hdr10_bloom_blur_scale),
				(float)(ps_r4_hdr10_bloom_intensity),
				(float)(ps_r4_hdr10_sun_intensity)
			);
		}
#endif
	}
} binder_hdr10_parameters4;

class cl_binder_hdr10_parameters5 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_sun_dawn_begin),
				(float)(ps_r4_hdr10_sun_dawn_end),
				(float)(ps_r4_hdr10_sun_dusk_begin),
				(float)(ps_r4_hdr10_sun_dusk_end)
			);
		}
#endif
	}
} binder_hdr10_parameters5;

class cl_binder_hdr10_parameters6 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_brightness),
				(float)(1.0f / ps_r4_hdr10_gamma),
				(float)(ps_r4_hdr10_flare_threshold),
				(float)(ps_r4_hdr10_flare_power)
			);
		}
#endif
	}
} binder_hdr10_parameters6;

class cl_binder_hdr10_parameters7 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_flare_ghosts),
				(float)(ps_r4_hdr10_flare_ghost_dispersal),
				(float)(ps_r4_hdr10_flare_center_falloff),
				(float)(ps_r4_hdr10_flare_halo_scale)
			);
		}
#endif
	}
...
class cl_binder_hdr10_parameters8 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_flare_halo_ca),
				(float)(ps_r4_hdr10_flare_ghost_ca),
				(float)(ps_r4_hdr10_flare_blur_scale),
				(float)(ps_r4_hdr10_ui_saturation + 1.0f)
			);
		}
#endif
	}
} binder_hdr10_parameters8;

class cl_binder_hdr10_parameters9 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_flare_ghost_intensity),
				(float)(ps_r4_hdr10_flare_halo_intensity),
				(float)(ps_r4_hdr10_sun_inner_radius),
				(float)(ps_r4_hdr10_sun_outer_radius)
			);
		}
#endif
	}
} binder_hdr10_parameters9;

class cl_binder_hdr10_parameters10 : public R_constant_setup
{
	virtual void setup(R_constant* C)
	{
#if RENDER == R_R4
		if (RImplementation.o.dx11_hdr10)
		{
			RCache.set_c(
				C,
				(float)(ps_r4_hdr10_flare_lens_color.x),
				(float)(ps_r4_hdr10_flare_lens_color.y),
				(float)(ps_r4_hdr10_flare_lens_color.z),
				(float)(ps_r4_hdr10_sun_on)
			);
		}
#endif
	}
} binder_hdr10_parameters10;
/* --- HDR10 Parameters --- */
