...
public:
	...
	{
		xrCriticalSection::raii guard(&callback_cs);
		Update_Callback = C;
		Update_Callback_Param = Param;
	}
	xrCriticalSection calc_bones_cs, callback_cs;
	//	Callback: data manipulation
	virtual void SetUpdateCallback(UpdateCallback pCallback) { xrCriticalSection::raii guard(&callback_cs); Update_Callback = pCallback; }
	virtual void SetUpdateCallbackParam(void* pCallbackParam) { xrCriticalSection::raii guard(&callback_cs); Update_Callback_Param = pCallbackParam; }

	virtual UpdateCallback GetUpdateCallback() { xrCriticalSection::raii guard(&callback_cs); return Update_Callback; }
	virtual void* GetUpdateCallbackParam() { xrCriticalSection::raii guard(&callback_cs); return Update_Callback_Param; }
