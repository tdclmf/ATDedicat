...
float occlusion_break_time = 0.001f;
// R1-specific
...
int multithreaded_texture_loading = 1;
...
void xrRender_initconsole()
{
	...
	CMD4(CCC_Float, "occlusion_break_time", &occlusion_break_time, 0.0f, 1.f);
	...
	CMD4(CCC_Integer, "r__detail_batchsize", &ps_r__detail_BatchSize, 1, 4096);
	...
	CMD4(CCC_Integer, "multithreaded_texture_loading", &multithreaded_texture_loading, 0, 1);
