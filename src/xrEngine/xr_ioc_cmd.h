...
public:
	...
	virtual void fill_tips(vecTips& tips, u32 mode)
	{
		...
		tips.push_back(str);
		xr_sprintf(str, sizeof(str), "%f", *value);
		tips.push_back(str);
...
:
	...
	{
		TStatus str;
		xr_sprintf(str, sizeof(str), "(%f, %f, %f) (current) [(%f,%f,%f)-(%f,%f,%f)]", value->x, value->y, value->z,
...
:
	...
	virtual void Info(TInfo& I)
	{
		xr_sprintf(I, sizeof(I), "vector4 in range [%f,%f,%f,%f]-[%f,%f,%f,%f]", min.x, min.y, min.z, min.w, max.x, max.y, max.z, max.w);
	}

	virtual void fill_tips(vecTips& tips, u32 mode)
	{
		TStatus str;
		xr_sprintf(str, sizeof(str), "(%f, %f, %f, %f) (current) [(%f,%f,%f,%f)-(%f,%f,%f,%f)]", value->x, value->y, value->z, value->w,
			min.x, min.y, min.z, min.w, max.x, max.y, max.z, max.w);
		tips.push_back(str);
		xr_sprintf(str, sizeof(str), "%f, %f, %f, %f", value->x, value->y, value->z, value->w);
		tips.push_back(str);
		IConsole_Command::fill_tips(tips, mode);
	}
};
		...
		:
			...
			virtual void fill_tips(vecTips& tips, u32 mode)
			{
				...
				xr_sprintf(str, sizeof(str), "(%i, %i, %i) (current) [(%i,%i,%i)-(%i,%i,%i)]", value->x, value->y, value->z,
					min.x, min.y, min.z, max.x, max.y, max.z);
				tips.push_back(str);
				xr_sprintf(str, sizeof(str), "%i, %i, %i", value->x, value->y, value->z);
				tips.push_back(str);
				IConsole_Command::fill_tips(tips, mode);
			}
};
		...
		:
			...
			virtual void fill_tips(vecTips& tips, u32 mode)
			{
				...
				xr_sprintf(str, sizeof(str), "(%i, %i, %i, %i) (current) [(%i,%i,%i,%i)-(%i,%i,%i,%i)]", value->x, value->y, value->z, value->w,
					min.x, min.y, min.z, min.w, max.x, max.y, max.z, max.w);
				tips.push_back(str);
				xr_sprintf(str, sizeof(str), "%i, %i, %i, %i", value->x, value->y, value->z, value->w);
				tips.push_back(str);
				IConsole_Command::fill_tips(tips, mode);
			}
};
...
public:
	...
	virtual void fill_tips(vecTips& tips, u32 mode)
	{
		...
		tips.push_back(str);
		xr_sprintf(str, sizeof(str), "%d", *value);
		tips.push_back(str);
		IConsole_Command::fill_tips(tips, mode);
	}
};
