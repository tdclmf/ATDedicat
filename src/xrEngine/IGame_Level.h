...
public:
	...
	virtual void Draw3dPDA() {;};
	void d3dtext_renderer(Fvector pos, LPCSTR str = NULL, u32 color = color_rgba(0, 255, 100, 255));
	void d2dtext_renderer(Ivector2 pos, LPCSTR str = NULL, u32 color = color_rgba(255, 255, 255, 255));
	...
	virtual void SoundEvent_Dispatch();
	virtual void script_gc() {};
	virtual void script_gc_start() {};
	virtual void script_gc_stop() {};
	virtual void UI_AND_PHCommanders() {};
	virtual void UpdateBulletManager() {};
