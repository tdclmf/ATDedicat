...
namespace thread_data
{
	...
	static thread_local xrXRC xrc; // MT: dangerous
	static thread_local collide::rq_results r_temp; // MT: dangerous
	static thread_local xr_vector<ISpatial*> r_spatial; // MT: dangerous
}
using namespace thread_data;
//--------------------------------------------------------------------------------
// RayTest - Occluded/No
//--------------------------------------------------------------------------------
...
{
	static thread_local xr_vector<CObject*> ignore_objects; ignore_objects.clear();
	if (ignore_object)
